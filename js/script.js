...
const galleries = {
  Ads: [
    { id: "ad1", title: "Volunteer Tutor Campaign", thumb: "images/DNC.png", img: "images/DNC.png", alt: "Colorful flyer with a tutor helping a student illustration.", excerpt: "A cheerful campaign inviting volunteers to become tutors and support local students.", content: "This promotional flyer for Notre Dame Learning Center uses bright colors and friendly illustration to attract new volunteer tutors. The bold headline, 'Make a Lasting Impact on a Child’s Life,' highlights the importance of mentorship, while playful typography and a warm palette create a welcoming tone. The design combines clarity, emotion, and accessibility—ideal for community outreach and digital promotion." },
    { id: "ad2", title: "Golfing for Good 2026", thumb: "images/golf.png", img: "images/golf.png", alt: "Golf tournament poster with a golfer mid-swing.", excerpt: "A bold and energetic event poster for NDLC's annual charity golf tournament.", content: "This dynamic design announces the 2026 'Golfing for Good' tournament, emphasizing movement and excitement through an action photo of a golfer mid-swing. The typography layers vibrant greens and yellows with high contrast to draw attention to the event date and location. Details like mulligans, foursomes, and contact info are clearly framed, merging professionalism with visual enthusiasm to inspire participation and support NDLC’s mission." },
    { id: "ad3", title: "Enter to Win Raffle", thumb: "images/raffle.png", img: "images/raffle.png", alt: "Raffle flyer with illustrated tickets and star motifs.", excerpt: "A fun, festive flyer inviting community members to enter a raffle supporting education.", content: "Designed to capture excitement and generosity, this raffle poster features playful hand-lettered typography and a bright star-filled background. It promotes NDLC’s gift basket fundraiser with clear pricing tiers and bold, easy-to-read layout. The color palette of reds, yellows, and blues evokes joy and community engagement, while the composition balances whimsy with professionalism—encouraging viewer participation." },
    { id: "ad4", title: "Thanks for Giving Raffle", thumb: "images/thanks.png", img: "images/thanks.png", alt: "Autumn raffle poster with fall colors and a QR code.", excerpt: "A warm, autumn-themed fundraiser poster celebrating community generosity.", content: "This seasonal poster blends gratitude and excitement for NDLC’s November raffle. Warm oranges and golds paired with ticket illustrations evoke fall energy, while clear hierarchy and a centered QR code enhance accessibility. The design feels festive but balanced, reinforcing NDLC’s message of thankfulness and impact during the holiday season." }
  ],
  Logo: [
    { id: "l1", title: "Black Cat Coffee Logo", thumb: "images/blackcatcoffee.png", img: "images/blackcatcoffee.png", alt: "Logo with a black cat silhouette behind a coffee cup.", excerpt: "A sleek, high-contrast logo combining simplicity with playful character.", content: "This logo design merges the silhouette of a curled cat with a coffee cup, forming a cohesive black-and-white mark. Its bold, geometric balance and rounded typeface suggest both friendliness and sophistication. The clean vector style ensures versatility across packaging, signage, and merchandise, giving the brand a recognizable and modern identity." },
