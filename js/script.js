...
const galleries = {
  Ads: [
    ...
    { id: "ad4", title: "Thanks for Giving Raffle", thumb: "images/thanks.png", img: "images/thanks.png", alt: "Autumn raffle poster with fall colors and a QR code.", excerpt: "Holiday-season print piece celebrating generosity while promoting a fall raffle.", content: "This seasonal poster blends gratitude and excitement for NDLC’s November raffle. Warm oranges and golds paired with ticket illustrations evoke fall energy, while clear hierarchy and a centered QR code enhance accessibility. The design feels festive but balanced, reinforcing NDLC’s message of thankfulness and impact during the holiday season." }
  ],
  Logo: [
